...
\begin{itemize}
    ...
    \begin{example}{Controesempio per proprietà semantica}{controesempio-proprieta-semantica}
...
\begin{definition}{Istanza di Transazioni}{istanza-di-transazio}
...
\begin{definition}{Independent Set (IS)}{independent-set-is}
