...
\begin{enumerate}
    ...
    \item Una volta terminati gli $0$s, riposiziona la testina dell'input tape all'inizio degli $1$.
    ...
    \item Confronta i due conteggi binari (uno dopo gli $0$s, uno dopo gli $1$). Se sono uguali e la stringa è della forma corretta ($0...01...1$), la TM accetta; altrimenti, rigetta.
\end{enumerate}
