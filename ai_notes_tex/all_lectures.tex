...
\chapter{Macchine di Turing e Linguaggi Decidibili}
...
\begin{figure}[h!]
    \centering
    \input{../tm.tex}
    \caption{Diagramma di stati per la Macchina di Turing che riconosce $L = \{A^n B^n \mid n \ge 0\}$.\\ \small{\textbf{Nota}}: Le etichette degli archi sono nel formato: \texttt{Letto/Scritto, Movimento}. Per chiarezza, il simbolo \textit{blank} è indicato con $\sqcup$. L'automa implementa la logica descritta nel testo.}
\end{figure}
...
\chapter{Riduzioni e Indecidibilità}
