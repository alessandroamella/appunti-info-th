...
def create_master_document(
    ...
    with open(output_file, "w", encoding="utf-8") as master_doc:
        ...
        master_doc.write(
            "Questo documento è la versione compilata automaticamente di tutti i miei appunti del corso di Informatica Teorica, tenuto dal Prof. Enrico Malizia, per la Laurea in Informatica all'Università di Bologna.\n\n"
        )
